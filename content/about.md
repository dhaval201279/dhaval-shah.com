...
------------------------------------------------------------------------------
I am a Principal Software Architect with more than 2 decades of experience designing and scaling distributed platforms. Specialized in high-throughput, low-latency backend systems built using Java, reactive microservices, and event-driven architectures.
Proven track record architecting resilient platforms processing 1000+ TPS with sub-100ms latency, designing distributed pipelines handling 200K+ user provisioning workflows.

Recognized for leading complex production problem resolution, institutionalizing [NFRs](https://en.wikipedia.org/wiki/Non-functional_requirement) i.e. **Costs Optimization**, **Performance Engineering**, **Observability**, **Resiliency** as first class requirements and shaping scalable cloud-native architectures.
...
### Scope of Impact
- Architected distributed backend systems powering global fintech platforms processing **1000+ transactions per second**
- Designed high-throughput pipelines to **provision 200K+ users** by orchestrating 15+ downstream services per workflow with strict ordering and failure isolation
- Led **performance engineering** initiatives improving platform efficiency by 30–40%
- Optimized platform cost by 20% through **FINOPS** principles 
...
Linkedin profile - [Dhaval Shah](https://www.linkedin.com/in/dhavalshah201279/)
